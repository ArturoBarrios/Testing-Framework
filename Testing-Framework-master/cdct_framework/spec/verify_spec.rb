...
describe 'test' do
  ...
  it 'can delete an airplane correctly' do
    ...
    ####FLIGHTS####
  it 'can get a flight correctly' do
  #Read and parse the file into JSON format
  file = File.read('json_files/get_flight.json')
  json_payload = JSON.parse(file)
  ...
  it 'can create a flight by post correctly' do
  file = File.read('json_files/post_flight.json')
  json_payload = JSON.parse(file)
  ...
  expect(service_response.code).to eq(json_payload['expected_response_code'])
  expect(response_body).to eq(json_payload['expected_response_body'])
  ApiCall.call_service("http://127.0.0.1:8000/myapp/flights/99",'DELETE',{})
  end

  it 'can update a flight by put correctly' do
  #Read and parse the file into JSON format
  file = File.read('json_files/put_flight.json')
  json_payload = JSON.parse(file)
  ...
  it 'can delete a flight correctly' do
  file = File.read('json_files/delete_flight.json')
  json_payload = JSON.parse(file)
  #Retrieve the values from the JSON file
  url = json_payload['service_url']
  data = ApiCall.call_service(url,'GET').body
  ...
  expect(service_response.code).to eq(json_payload['expected_response_code'])
  expect(response_body).to eq(json_payload['expected_response_body'])
  ApiCall.call_service("http://127.0.0.1:8000/myapp/flights/",'POST',data)
  end
  ...
  it 'can update a airport by put correctly' do
    ...
    expect(service_response.code).to eq(json_payload['expected_response_code'])
    expect(JSON.parse(service_response.body)).to eq(json_payload['expected_response_body'])
    ApiCall.call_service("http://127.0.0.1:8000/myapp/airports/999",'DELETE',{})
  end

  it 'can delete an airport correctly' do
  file = File.read('json_files/delete_airport.json')
  json_payload = JSON.parse(file)
  #Retrieve the values from the JSON file
  url = json_payload['service_url']
  data = ApiCall.call_service(url,'GET').body
  ...
  expect(service_response.code).to eq(json_payload['expected_response_code'])
  expect(response_body).to eq(json_payload['expected_response_body'])
  ApiCall.call_service("http://127.0.0.1:8000/myapp/airports/",'POST',data)
  end
end
